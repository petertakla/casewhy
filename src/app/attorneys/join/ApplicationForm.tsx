...
import { submitAttorneyApplication } from "./actions";
...
export function ApplicationForm() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      const result = await submitAttorneyApplication({
        name,
        firm,
        statesLicensed,
        barNumber,
    ...
    return (
      <div className="rounded-2xl border border-border bg-surface p-6">
        ...
        <p className="mt-1 text-sm text-muted">
          Thanks — we&apos;ll confirm your bar standing and be in touch before listing you.
        </p>
      </div>
    );
  }
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <Field label="Practice areas">
        <input
          ...
          className={inputClass}
          placeholder="e.g. Asylum, family-based, employment-based"
        />
      </Field>
