...
export const metadata: Metadata = pageMetadata("/attorneys/join", {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-xl px-6 py-10">
      ...
      <p className="mt-2 text-sm text-muted">
        For licensed immigration attorneys. This is an informational listing,
        not an endorsement: every application is reviewed against your state
        bar&apos;s public lookup tool before anyone is added.
      </p>
