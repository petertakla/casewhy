...
} from "@/lib/community-orgs/directory";

export const metadata: Metadata = pageMetadata("/community-orgs", {
...
export default async function CommunityOrgsPage() {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-6 py-10">
      <LanguageSwitcher es={false} href="/es/community-orgs" />

      <h1 className="text-2xl font-bold tracking-tight">
        Find a community or cultural organization
      </h1>
      <p className="mb-2 mt-2 text-muted">
        Community and cultural organizations that have received a federal USCIS
        grant specifically for citizenship instruction and naturalization help.
        This reflects organizations that won this specific grant — not all
      ...
      {directory.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-border-strong p-8 text-center">
          <p className="text-sm text-muted">
            ...
            meantime, USCIS publishes its own{" "}
            <a
              ...
              <div className="rounded-xl border border-border bg-surface transition-colors hover:border-border-strong">
                ...
                >
                  ...
                  <p className="mt-1 text-xs text-muted">
                    USCIS grant recipient — {org.fiscalYearsAwarded}
                  </p>
                </Link>
