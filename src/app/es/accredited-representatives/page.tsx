...
export default async function AccreditedRepresentativesPageEs() {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-6 py-10">
      <LanguageSwitcher es={true} href="/accredited-representatives" />

      <h1 className="text-2xl font-bold tracking-tight">
        Encuentra un representante acreditado
      </h1>
      <p className="mb-2 mt-2 text-muted">
        Representantes acreditados por el DOJ — no abogados autorizados a
        practicar leyes de inmigración, típicamente en organizaciones sin fines
        de lucro. Obtenido del propio registro público del DOJ, a nivel
        nacional.
      </p>
      ...
      <p className="mt-8 text-sm text-muted">
        ¿Representas a una organización sin fines de lucro con personal
        acreditado por el DOJ?{" "}
        <Link
