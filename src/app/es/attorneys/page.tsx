...
export const metadata: Metadata = pageMetadata("/es/attorneys", {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-6 py-10">
      ...
      <p className="mb-2 mt-2 text-muted">
        Abogados de inmigración — especialistas certificados obtenidos de
        registros oficiales de colegios de abogados estatales, más listados de
        auto-inscripción — para cualquier cosa que CaseWhy te indique que
        necesita el criterio de un profesional con licencia.
      </p>
      ...
      {directory.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-border-strong p-8 text-center">
          <p className="text-sm text-muted">
            ...
            tanto, la American Immigration Lawyers Association mantiene un{" "}
            <a
