...
export const metadata: Metadata = pageMetadata("/es/community-orgs", {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-6 py-10">
      ...
      <h1 className="text-2xl font-bold tracking-tight">
        Encuentra una organización comunitaria o cultural
      </h1>
      <p className="mb-2 mt-2 text-muted">
        Organizaciones comunitarias y culturales que han recibido una subvención
        federal de USCIS específicamente para instrucción cívica y ayuda de
        naturalización. Esto refleja organizaciones que ganaron esta subvención
        específica — no todas las organizaciones comunitarias que sirven a
        inmigrantes.
      </p>
      ...
      {directory.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-border-strong p-8 text-center">
          <p className="text-sm text-muted">
            ...
            tanto, USCIS publica sus propios{" "}
            <a
            ...
            >
              registros de beneficiarios del Programa de Subvenciones de
              ...
              <div className="rounded-xl border border-border bg-surface transition-colors hover:border-border-strong">
                ...
                >
                  ...
                  <p className="mt-1 text-xs text-muted">
                    Beneficiario de subvención USCIS — {org.fiscalYearsAwarded}
                  </p>
                </Link>
      ...
      <p className="mt-8 text-sm text-muted">
        ¿Diriges una organización comunitaria o cultural que sirve a
        inmigrantes?{" "}
        <Link
