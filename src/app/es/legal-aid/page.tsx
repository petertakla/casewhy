...
export const metadata: Metadata = pageMetadata("/es/legal-aid", {
  title:
    "Encuentra Asistencia Legal de Inmigración Gratuita o de Bajo Costo | CaseWhy",
  description:
...
export default async function LegalAidPageEs() {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-6 py-10">
      <LanguageSwitcher es={true} href="/legal-aid" />

      <h1 className="text-2xl font-bold tracking-tight">
        Encuentra una organización de asistencia legal
      </h1>
      <p className="mb-2 mt-2 text-muted">
        Organizaciones sin fines de lucro reconocidas por el DOJ para brindar
        ayuda legal de inmigración, a menudo con bajo o ningún costo. Obtenido
        del propio registro público del DOJ, a nivel nacional.
      </p>
      ...
      {directory.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-border-strong p-8 text-center">
          <p className="text-sm text-muted">
            ...
            tanto, el Departamento de Justicia publica su propio{" "}
            <a
            ...
            >
              registro de Organizaciones Reconocidas y Representantes
              Acreditados
            </a>{" "}
            (en inglés).
          </p>
      ...
      <p className="mt-8 text-sm text-muted">
        ¿Diriges una organización sin fines de lucro que brinda ayuda legal de
        inmigración?{" "}
        <Link
          href="/legal-aid/join"
