...
export const metadata: Metadata = pageMetadata("/es/pro-bono-representation", {
  title:
    "Encuentra Representación Gratuita en la Corte de Inmigración | CaseWhy",
  description:
  ...
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-6 py-10">
      ...
      <h1 className="text-2xl font-bold tracking-tight">
        Encuentra representación gratuita en la corte de inmigración
      </h1>
      <p className="mb-2 mt-2 text-muted">
        Organizaciones que ofrecen representación gratuita en procesos ante la
        corte de inmigración (defensa contra deportación), organizadas por la
        corte de inmigración a la que sirven — una necesidad más específica y a
        menudo de mayor riesgo que la asistencia legal general.
      </p>
