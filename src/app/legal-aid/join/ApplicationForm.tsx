...
import { submitLegalAidApplication } from "./actions";
...
export function ApplicationForm() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      const result = await submitLegalAidApplication({
        organizationName,
        orgType,
        contactPerson,
        statesServed,
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <Field label="Organization type">
        <input
          ...
          className={inputClass}
          placeholder="e.g. Nonprofit legal aid clinic, faith-based immigration ministry"
        />
      </Field>
      ...
      <Field label="Population served">
        <input
          ...
          className={inputClass}
          placeholder="e.g. Low-income families, asylum seekers, DACA recipients"
        />
      </Field>
      <Field label="Services offered">
        <textarea
          ...
          className={inputClass}
          placeholder="e.g. Free consultations, naturalization clinics, DACA renewals"
        />
      </Field>
