...
export const metadata: Metadata = pageMetadata("/legal-aid/join", {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-xl px-6 py-10">
      ...
      <p className="mt-2 text-sm text-muted">
        For nonprofit organizations providing immigration legal help — legal aid
        clinics, faith-based immigration ministries, and similar recognized
        nonprofits. This is an informational listing, not an endorsement: every
        application is reviewed before anyone is added.
      </p>
