...
} from "@/lib/legal-aid/directory";

export const metadata: Metadata = pageMetadata("/legal-aid", {
...
export default async function LegalAidPage() {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-6 py-10">
      <LanguageSwitcher es={false} href="/es/legal-aid" />

      <h1 className="text-2xl font-bold tracking-tight">
        Find a legal aid organization
      </h1>
      <p className="mb-2 mt-2 text-muted">
        Nonprofit organizations recognized by the DOJ to provide immigration
        legal help, often at low or no cost. Sourced from DOJ&apos;s own public
        roster, nationwide.
      </p>
